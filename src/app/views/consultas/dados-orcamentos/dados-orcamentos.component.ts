  ...
  exportXlsx() {
    ...
    this.relatorioDadosOrcamento.listaDadosOrcamento.forEach(x => {
      let item = {
        ...
        DescMedioDescSuperiorAVistaOpcao1: x.DescMedioDescSuperiorAVistaOpcao1 ? { t: 'n', v: x.DescMedioDescSuperiorAVistaOpcao1 / 100, z: "0.00%" } : null,
        ...
        DescMedioDescSuperiorAPrazoOpcao1: x.DescMedioDescSuperiorAPrazoOpcao1 ? { t: 'n', v: x.DescMedioDescSuperiorAPrazoOpcao1 / 100, z: "0.00%" } : null,
        ...
        DescMedioDescSuperiorAVistaOpcao2: x.DescMedioDescSuperiorAVistaOpcao2 ? { t: 'n', v: x.DescMedioDescSuperiorAVistaOpcao2 / 100, z: "0.00%" } : null,
        ...
        DescMedioDescSuperiorAPrazoOpcao2: x.DescMedioDescSuperiorAPrazoOpcao2 ? { t: 'n', v: x.DescMedioDescSuperiorAPrazoOpcao2 / 100, z: "0.00%" } : null,
        ...
        DescMedioDescSuperiorAVistaOpcao3: x.DescMedioDescSuperiorAVistaOpcao3 ? { t: 'n', v: x.DescMedioDescSuperiorAVistaOpcao3 / 100, z: "0.00%" } : null,
        ...
        DescMedioDescSuperiorAPrazoOpcao3: x.DescMedioDescSuperiorAPrazoOpcao3 ? { t: 'n', v: x.DescMedioDescSuperiorAPrazoOpcao3 / 100, z: "0.00%" } : null,
